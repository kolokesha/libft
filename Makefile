...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c \
	 ...
	 ft_lstaddend.c ft_max.c ft_swap.c ft_intlen.c ft_atoi_base.c \
	 ft_lstfold.c ft_isupper.c ft_islower.c
...
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o \
		...
		ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o  ft_lstnew.o \
		ft_lstdel.o ft_lstdelone.o ft_lstadd.o ft_lstiter.o ft_lstmap.o \
		ft_lstaddend.o ft_max.o ft_swap.o ft_intlen.o ft_atoi_base.o \
		ft_lstfold.o ft_isupper.o ft_islower.o
